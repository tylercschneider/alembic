  ...
  module Flow
    class VersionTest < ActiveSupport::TestCase
      ...
      test "is valid when a different diagnostic already has that version number" do
        Definition.create!(slug: "taken").definition_versions.create!(number: 1, definition: { "slug" => "taken" })
        diagnostic = Definition.create!(slug: "demo")
      ...
      test "its status may change" do
        version = Definition.create!(slug: "demo").definition_versions.create!(number: 1, definition: { "slug" => "demo" })
